...
module.exports = async (req, res, next) => {
  ...
  try {
    ...
    const { data: updatedData } = await gDriveApi.appendValues(process.env.SHEET_ID, 'data!B2', 'USER_ENTERED', 'INSERT_ROWS', { values: [[`https://docs.google.com/spreadsheets/d/${gSheetId}/`]] });
